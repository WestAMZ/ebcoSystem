...
EOT;
    ...
    public function testMessageID()
    {
        ...
        $iduser = md5(12345);
        $this->Mail->MessageID = $iduser;
        $this->buildBody();
        $this->Mail->preSend();
        $lastid = $this->Mail->getLastMessageID();
        $this->assertNotEquals($lastid, $iduser, 'Invalid Message ID allowed');
        $iduser = '<'.md5(12345).'@example.com>';
        $this->Mail->MessageID = $iduser;
        $this->buildBody();
        $this->Mail->preSend();
        $lastid = $this->Mail->getLastMessageID();
        $this->assertEquals($lastid, $iduser, 'Custom Message ID not used');
        $this->Mail->MessageID = '';
        $this->buildBody();
        $this->Mail->preSend();
        $lastid = $this->Mail->getLastMessageID();
